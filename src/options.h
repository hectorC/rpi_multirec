...
void PrintUsage(const char* exe) {
  std::printf(
      ...
      "  -o, --out <path>        Output RF64/WAV file (default: auto name)\n"
      ...
      "  <mic>_YYYYMMDD_HHMMSS.wav\n"
      "  Files use RF64/WAV format; .wav is used for DAW compatibility.\n"
      ...
      "  SETTINGS: Joystick UP/DOWN selects DATE/TIME or TRANSFER\n"
      "  SETTINGS DATE/TIME: KEY1 edits, LEFT/RIGHT selects field,\n"
      "                      UP/DOWN changes value, KEY2 sets time\n"
      "  SETTINGS TRANSFER: KEY1 opens transfer page, KEY2 starts copy\n"
      "                     KEY2 deletes copied files after success\n"
      "                     SD->EXT in normal mode, EXT->SD in E mode\n"
